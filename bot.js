...
const prefix = "*"; // البرافيكس
   const GUILDID = '694766319983263794'; // اي دي السيرفر  
   const CHANNELID = '746317826922643507'; // اي دي الروم
//======================================[Client]======================================
// CODE BY KAHRBAA كههربا

client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("القران الكريم بصوت محمد اللحيدان",{type: 'WATCHING'})
});
// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://youtu.be/5embyWrfnuE'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا
